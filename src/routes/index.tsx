...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Never forget a client, requirement, or follow-up. WhatsApp-native CRM for brokers and agents in India." },
    ],
  }),
  component: Landing,
});
      ...
      <header className="sticky top-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/auth"><Button size="sm" className="shadow-[var(--shadow-glow)]">Get started</Button></Link>
          </div>
        </div>
      </header>
